 ...
 * playing with either a human or AI
 * The winner is the first to match 3 cells in order either vertically, horizontally or diagonally
 *
 * @author Zahra Rafie
 */
public class TicTacToe {
    ...
    /**
     * prints out the main menu of the game for user interface
     ...
     *
     * @return inputKey the input for the menu
     */
    ...
    /**
     * user can continue to or restart the game by pressing Enter key
     */
     ...
     */
    public static void generateRandomLucks(int[] randArr) {
        for (int i = 0; i < 3; i++) {
    ...
    /**
     * prints the 4x4 game board for user interface
     *
    ...
    /**
     * reset game parameters for further playing
    ...
    /**
     * places the position played by each player
     *
     * @param gameBoard given to the method to set value to each cell
     * @param pos       adds the played position to the array
     ...
     */
    public static String checkWinner(String[] gameBoard, int pos, String win) {
        String firstLine = "";
        String secondLine = "";
        String thirdLine = "";
        String fourthLine = "";
